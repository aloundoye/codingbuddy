...
impl SlashCommand {
    pub fn parse(input: &str) -> Option<Self> {
        ...
        let cmd = match name.as_str() {
            ...
            "draft" | "drafts" => Self::Draft(args),
            "context" => Self::Context,
            "sandbox" => Self::Sandbox(args),
            "agents" => Self::Agents,
            "agent" => Self::Agent(args.first().cloned()),
...
pub const SLASH_COMMAND_CATALOG: &[(&str, &str)] = &[
    ...
    (
        "agent",
        "Switch agent profile (build/explore/plan/bash/general)",
    ),
    ...
    ("diff", "Show git diff"),
    ("undo", "Undo last conversation turn + file changes"),
    ("redo", "Redo a previously undone turn"),
    ("branch", "Create/list/switch session branches"),
    ("draft", "Save/load/list input drafts"),
